...
public enum OrderTypes
{
    ...
    // Отправка в академический отпуск
    // Студент должен быть зачислен
    FreeAcademicVacationSend = 19,
    // Отправка в академический отпуск
    // Студент должен быть зачислен
    FreeAcademicVacationReturn = 20,
    ...
    //      группа:
    //      не указывается
    PaidDeductionWithEducationProcessNotInitiated = 38,
    // В связи с неуспеваемостью
    //      студент:
    //      любой
    //      группа:
