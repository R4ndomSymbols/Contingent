...
public class LevelOfEducation {
    ...
    private static readonly Dictionary<string, LevelsOfEducation> _importDictionary = new (){
        {"", LevelsOfEducation.NotMentioned},
        {"нет", LevelsOfEducation.NotMentioned},
        {"основное общее образование", LevelsOfEducation.BasicGeneralEducation},
        {"среднее общее образование", LevelsOfEducation.SecondaryGeneralEducation},
        {"среднее профессиональное образование", LevelsOfEducation.SecondaryVocationalEducation},
    };
    ...
    public static int ImportLevelCode(string? name){
        ...
        if (_importDictionary.TryGetValue(name, out LevelsOfEducation found)){
            return (int)found;
        }
        return (int)LevelsOfEducation.NotMentioned;
    }
