...
public class TransferGroupToGroupOrder : Order
{
    public TransferGroupToGroupOrder() : base(){

    }
    protected TransferGroupToGroupOrder(int id) : base(id){

    }
    public override Task<bool> CheckInsertionPossibility()
    {
    ...
    {
        return OrderTypes.TransferGroupToGroup;
    }
    ...
    public static async Task<Order?> GetById(int id, ObservableTransaction? scope)
    {
        ...
        await using(cmd)
        {
            ...
            await reader.ReadAsync();
            return new TransferGroupToGroupOrder(id)
            {
    ...
    public override bool Equals(IDbObjectValidated? other)
    {
        ...
        var unboxed = (TransferGroupToGroupOrder)other;
        return 
            _id == unboxed._id;
    }
